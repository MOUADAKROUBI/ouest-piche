        ...
        <ul className="nav-menu">
          <li className="nav-item">
            <Link 
              ...
              className={`nav-link ${pathname === '/${user?.profile?.nickname}/me' ? 'active':''}`}
            >
              ...
              <div className="name-page">mon profile</div>
            </Link>
          </li>
          <li className="nav-item">
            <Link
              href={`/${user?.profile?.nickname}/me/orders`}
              className={`nav-link ${pathname === '/${user?.profile?.nickname}/orders' ? 'active':''}`}
            >
              <div className="icon-page">
                <svg
                  viewBox="0 0 24 24"
          ...
          <li className="nav-item">
            <Link
              ...
              className={`nav-link ${pathname === '/${user?.profile?.nickname}/likes' ? 'active':''}`}
            >
              <div className="icon-page">
                <svg
                  viewBox="0 0 24 24"
