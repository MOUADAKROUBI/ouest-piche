...
export default function Weather({ screen }: {screen: string}) {
  ...
  const handleMouseEnter = (
    ...
    setShowAlert(true);
    setAlertX(e.clientX);
    setAlertY(e.clientY - 20); // Offset for better positioning
  };
          ...
          <div>
            ...
            <div className="wind-humidity">
              <h4 className="wind">
                ...
                Vitesse du vent: {data.forecast.forecastday[0].day.maxwind_kph}
                kph
              </h4>
                ...
                <>
                  ...
                  >
                    ...
                    {(showAlert && alert === index) && (
                      <div
                        className="alert-ntf"
                        style={{ top: `${alertY}px`, left: `${alertX}px` }}
                      >
                        <span>
                          Attention! la prochaine marée est dans moins de 2 heures
                        </span>
                      </div>
                    )}
                  </div>
                  ...
                  {index <
                    data.forecast.forecastday[0].day.tides[0].tide.length - 1 && (
                    <div className="line"></div>
                  )}
                </>
              );
